...
@Component({
  selector: 'app-change-one-time-list',
  templateUrl: './change-one-time-list.component.html',
  styleUrls: ['./change-one-time-list.component.css']
})
export class ChangeOneTimeListComponent implements OnInit {
  public orderHistory = [];
  userInfo: any = {};
